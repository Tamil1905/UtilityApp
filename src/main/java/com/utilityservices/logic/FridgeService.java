...
public class FridgeService {
	...
	public static void FridgeServiceBook() throws Exception
	{
		List<AvailableDetails> details=FindServiceManDao.findFridgeServiceMan();
		for(AvailableDetails i: details)
		{
			System.out.println(i.getId()+"   "+i.getName()+"     "+i.getMobile()+"    "+i.getSpecialist_in()+"      "+i.getStatus());
		}
		FridgeServiceBooking();

	}
	public static void FridgeServiceBooking() throws Exception
	{
