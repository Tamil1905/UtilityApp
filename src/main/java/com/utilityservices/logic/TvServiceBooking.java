...
public class TvServiceBooking {
	static Scanner sc=new Scanner(System.in);
	public static void tvSerciceBook() throws Exception
	{
		List<AvailableDetails> details=FindServiceManDao.findTvServiceMan();
	...
	public static void tvServiceBooking() throws Exception
	{
