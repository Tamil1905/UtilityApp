...
public class WashMachineService {
	...
	public static void WashMachineServiceBook() throws Exception
	{
		List<AvailableDetails> details=FindServiceManDao.findWashingMachineServiceMan();
		for(AvailableDetails i: details)
		{
			System.out.println(i.getId()+"   "+i.getName()+"     "+i.getMobile()+"    "+i.getSpecialist_in()+"      "+i.getStatus());
		}
		WashMachineServiceBooking();

	}
	public static void WashMachineServiceBooking() throws Exception
	{
